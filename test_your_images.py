...
flags.DEFINE_string("test_data_dir", './images/your_test_images/', "test images")
...
def generate_images_from_folder(model, sess, test_data_dir="./images/test_your_images", train_data_dir="./images/train"):
    if test_data_dir:
